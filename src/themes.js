  ...
  'cosmic-abyss': {
    ...
    palette: {
      ...
      particles: {
        shieldHit: '#3df2ff',
        playerHit: '#7a5cff',
        enemyHitDefault: '#3df2ff',
        enemyHitStrafer: '#7a5cff',
        bossHit: '#7a5cff',
        bossCore: '#3df2ff',
      },
      enemies: {
      ...
      bullets: {
        playerLevels: ['#b7c6ff', '#d4f4ff', '#f1fbff'],
        enemyGlow: '#3df2ffaa',
        enemyFill: '#9aeaff',
        highlight: '#f1fbff',
        muzzleCore: '#7a5cff',
...
const THEME_BEHAVIOURS = {
  ...
  'cosmic-abyss': {
    ...
    paletteAdjustments: {
      particles: {
        enemyHitDefault: '#6be8ff',
        enemyHitStrafer: '#8b7bff',
        bossHit: '#8b7bff',
        bossCore: '#9df6ff',
      },
      bullets: {
        playerLevels: ['#b0c3ff', '#d0f1ff', '#eefaff'],
        highlight: '#f7feff',
        enemyGlow: '#4bf0ffaa',
        muzzleEdge: '#d0f1ff',
      },
